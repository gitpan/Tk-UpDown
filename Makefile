# This Makefile is for the Tk::UpDown extension to perl.
#
...
#	ABSTRACT => q[Number Navigation Widget]
#	AUTHOR => q[Sanjaysen]
#	DISTNAME => q[Tk-UpDown]
#	NAME => q[Tk::UpDown]
#	VERSION_FROM => q[UpDown.pm]
...
TO_INST_PM = UpDown.pm

PM_TO_BLIB = UpDown.pm \
	$(INST_LIBDIR)/UpDown.pm
...
manifypods : pure_all UpDown.pm
	@$(POD2MAN) \
	UpDown.pm \
	$(INST_MAN3DIR)/Tk::UpDown.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Tk-UpDown\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Tk-UpDown</TITLE>\n}. qq{\t<ABSTRACT>Number Navigation Widget</ABSTRACT>\n}. qq{\t<AUTHOR>Sanjaysen</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Tk-UpDown.ppd
